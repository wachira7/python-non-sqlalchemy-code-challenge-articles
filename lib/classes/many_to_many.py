...
class Magazine:
    ...
    @name.setter
    def name(self, value):
        # Validate and set the name of the magazine
    ...
    def category(self, value):
        # Validate and set the category of the magazine
        if not isinstance(value, str) or len(value) == 0:
            raise ValueError("Category must be a non-empty string.")
        self._category = value

    def articles(self):
        return self._articles  # Return the list of articles in the magazine

    def contributors(self):
        # Return a unique list of authors who have written for the magazine
    ...
    def contributing_authors(self):
        ...
        # Count the number of articles each author has written for the magazine
